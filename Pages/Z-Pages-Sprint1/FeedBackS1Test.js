...
class FeedBackS1Test { 

    signUpLink = $(`//button[text()="Sign in"]`)
    feedbackButtonLocator = $(`//a[text()="Feedback"]`)
    feedBackSubmitButton = $(`//button[@id="submit-button"]`)
    ...
    async openVerifyandswitchToNewPage() {
        let feedbackLocator = await this.feedbackButtonLocator
        await feedbackLocator.click() 
    ...
    async clickSubmitButton() {
        let feedBackSubmitButton1 = await this.feedBackSubmitButton
        await feedBackSubmitButton1.scrollIntoView()
        await browser.pause(5000)
        await feedBackSubmitButton1.click()
        await browser.pause(5000)
    }
    ...
    //     let feedBackSubmitButton = await this.feedBackSubmitButton
...
//OG CODE BELOW OG CODE BELOW OG CODE BELOW OG CODE BELOW OG CODE BELOW OG CODE BELOW OG CODE BELOW OG CODE BELOW OG CODE BELOW OG CODE BELOW OG CODE BELOW OG CODE BELOW
